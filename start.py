...
""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "🌐 مبرمج السورس", url="https://t.me/Tom_01157"
                    )
                ],
            ]
        ),
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("✨ مبرمج السورس يبني..😺♥", url=f"https://t.me/Tom_01157"),
                InlineKeyboardButton(
                    "📣 قناة السورس", url=f"https://t.me/Tom01255"
                ),
            ]
        ]
    )
        ...
        if member.id == bot_id:
            return await m.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("📣 قناة السورس", url=f"https://t.me/Tom01255"),
                            InlineKeyboardButton("💭 البشمبرمج", url=f"https://t.me/Tom_01157")
                        ],
                        [
